...
const firebase = {
  auth: jest.fn(() => ({
    currentUser: { displayName: 'Emi', photoURL: 1, email: 'hello@gmail.com' },
...
describe('<Browse />', () => {
  it('renders the browse page with <SelectProfileContainer />', async () => {
    const { container, getByTestId, getByPlaceholderText, queryByTestId, getByText, getByAltText, debug } = render(
      <Router>
